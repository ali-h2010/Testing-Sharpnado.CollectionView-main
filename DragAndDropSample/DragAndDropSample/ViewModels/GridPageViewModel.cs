...
namespace DragAndDropSample.ViewModels
{
    ...
    public class GridPageViewModel : ANavigableViewModel
    {
        ...
        public ObservableRangeCollection<SillyDudeVmo> _sillyPeople;
        private ListMode _mode;
        private int _currentIndex = -1;

        private int? _selectedDudeId;

        public GridPageViewModel(INavigationService navigationService, ISillyDudeService sillyDudeService) : base(navigationService)
        {
        ...
        public ObservableRangeCollection<SillyDudeVmo> SillyPeople
        {
            get => _sillyPeople;
            set {
                SetAndRaise(ref _sillyPeople, value);
                    }
        }
        ...
        private void InitCommands()
        {
            ...
            ChangeTitleCommand = new Command(async () => await ChangeTitleClicked());
        ...
        public async Task ChangeTitleClicked()
        {
            SillyPeople.First().Name = "Hello";
        }
